...
import com.example.projectapp.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handle click, go to privious acitvity
    ...
    private void validateData() {
        ...
        description = binding.descriptionEdt.getText().toString().trim();
    ...
    private void uploadPdfToStorage() {
        ...
        String filePathAndName = "Projects/" + timestamp;
        //storage reference
    ...
    //selected selected category id and title
