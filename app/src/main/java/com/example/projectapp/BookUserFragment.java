...
import com.example.projectapp.adapters.AdapterPdfUser;
import com.example.projectapp.databinding.FragmentBookUserBinding;
...
public class BookUserFragment extends Fragment {
    ...
    private void loadMostViewedDownloadedBooks(String orderBy) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Projects");
        ref.orderByChild(orderBy).limitToLast(10)// load 10 most viewed or downloaded projects
